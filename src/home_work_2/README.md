...
Задания разделить по пакетам. Пакет home_work_2.loops содержит задания по циклам, пакет arrays содержит задания по массивам, пакет sorts содержит задания по сортировкам, пакет utils содержит все классы в названии которых есть слово Utils.
